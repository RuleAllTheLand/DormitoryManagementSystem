...
$(data).each(function(i,value){//arr为要遍历的数组，i为循环变量，value为数组下标为i的值
		 ...
		 $(".datalist tbody").append("<tr value="+JSON.stringify(value)+" ><td>"+value.dorNo+"</td><td>"+value.rNo+"</td> <td>  &nbsp<button class='dordel' >删除</button> </tr>");
